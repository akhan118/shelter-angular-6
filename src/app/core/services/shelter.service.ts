...
export class ShelterService {
  ...
  // http://localhost/shelter-API/backend/web/v1/api/shelterconfig?shelter_id=33 &shelter_address= %27147%20url%20street%27& shelter_address_city= %27Ypsilanti%27& shelter_address_zip= %2748211%27&shelter_county=wayne&shelter_address_state=mi&shelter_phone=3136857604&shelter_EIN=9999999&shelter_email=ab@aol.com&username=aguess1
  ...
  updateShelter(shelterDetails: object) {
    ...
    return this.http.get<Shelter[]>(`${this.baseUrl}/shelterconfig`, { headers, params });
  }
